...
function placeImageForScaredAndTrappedPieces(){
	...
	/*
		 I think one more thing we have to do is that store where ever
		 we have a cross image in a div as we will have to check if 
		 its still trapped, if not then remove the image from that div
	*/
